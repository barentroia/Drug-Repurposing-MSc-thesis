...
drugdistances100avg=read.table("DistanceMatrix100avg.txt",check.names=FALSE)
...
adjustedRandIndex(my_DRUG_COMMUNITIES$cID,drugClusters$Cluster) #yields 0.9886966
